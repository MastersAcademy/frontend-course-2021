...
// function sort(posts, sortMethod = 'default') {
//     switch (sortMethod) {
//         case ('default'):
//         default:
//             console.log(posts);
...
//     const newArr = [
//         {
//             title: article1TitleEl,
//             content: article1ContentEl
//         },
//         {
//             title: article2TitleEl,
//             content: article2ContentEl
//         },
//         {
//             title: article3TitleEl,
//             content: article3ContentEl
//         },
//         {
//             title: article4TitleEl,
//             content: article4ContentEl
//         }
//     ]
//     let postsAmount;
//     if (posts.length <= 4) {
...
//         newArr[i].title.textContent = posts[i].title;
//         newArr[i].contenttextContent = posts[i].body;
//     }
// }
// new Promise((resolve) => {
//     setTimeout(async () => {
