...
const inputDateField = document.querySelector(
    '[ data-role="input-date-field"]'
);
const getFridaysButton = document.querySelector(
    '[ data-role="get-fridays-button"]'
);
const isMonthLongButton = document.querySelector(
    '[ data-role="is-month-long-button"]'
);
const daysShortestWeekButton = document.querySelector(
    '[data-role="days-shortest-week-button"]'
);
const fullWeekInMonthButton = document.querySelector(
    '[data-role="full-week-month-button"]'
);
let date = "";
...
daysShortestWeekButton.addEventListener("click", () => {
    displayResult(
        '[data-role="days-shortest-week-output"]',
...
fullWeekInMonthButton.addEventListener("click", () => {
    displayResult(
        '[data-role="full-week-month-output"]',
