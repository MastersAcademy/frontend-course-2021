...
getFridaysButton.addEventListener('click', () => {
    displayResult('[data-role="get-fridays-output"]',
        `[${getFridaysOfMonth(date)}]`);
});

isMonthLongButton.addEventListener('click', () => {
    displayResult('[data-role="is-month-long-output"]',
        isMonthLong(date));
});

daysShortestWeekButton.addEventListener('click', () => {
    displayResult('[data-role="days-shortest-week-output"]',
        shortestWeekDaysNumber(date));
});

fullWeekInMonthButton.addEventListener('click', () => {
    displayResult('[data-role="full-week-month-output"]',
